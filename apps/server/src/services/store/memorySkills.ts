...
export const fallbackSkillBody = (request: string): string =>
  [
    "# Workflow",
    "",
    "- Use this skill when the task matches the request that created it.",
    "- Treat the user's current request as primary; use this skill as procedural guidance.",
    "- Keep outputs concrete, scoped, and verified.",
    "",
    "## Original Request",
    "",
