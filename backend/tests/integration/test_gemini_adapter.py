...
@pytest.mark.asyncio
async def test_gemini_integration(capsys: pytest.CaptureFixture[str]):
    """
    Integration test for GeminiAdapter using:
    1. gemini-3-flash-preview model
    2. Thinking level configuration (OFF -> maps to minimal)
