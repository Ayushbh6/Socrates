...
def test_settings_resolve_socrates_home_defaults(monkeypatch, tmp_path):
    ...
    assert settings.app_data_dir == tmp_path / ".socrates" / "app-data"
    assert settings.uploads_dir == tmp_path / ".socrates" / "app-data" / "files" / "uploads"
