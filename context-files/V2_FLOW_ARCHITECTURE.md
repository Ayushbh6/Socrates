...
- A query outline inside the shared overlay sidebar for deliberate history navigation. It lists the loaded exchanges, marks the current exchange, can fetch earlier query batches, and returns to the current exchange without changing the active goal.
