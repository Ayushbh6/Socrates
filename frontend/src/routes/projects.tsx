...
function ProjectsLayout() {
  ...
  return (
    <div className="relative h-screen w-screen max-w-full overflow-hidden bg-canvas text-ink">
      <div
        aria-hidden
      ...
      <div className="relative z-10 flex h-screen min-w-0 flex-col overflow-hidden">
        ...
        >
          <div
            className={isConversationRoute
              ? 'mx-auto flex h-20 w-full min-w-0 max-w-[1440px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-10'
              : 'mx-auto flex min-h-[72px] w-full min-w-0 max-w-[1440px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-10'}
          >
            ...
            <div className="flex min-w-0 shrink-0 items-center gap-2 sm:gap-3">
              <Button
                asChild
                variant="outline"
                className="h-10 max-w-[52vw] overflow-hidden rounded-full border-0 bg-white/74 px-3 text-sm text-ink shadow-none hover:bg-sage/90 sm:max-w-none sm:px-4"
              >
                <Link to={headerCta.to} className="min-w-0">
                  <HeaderIcon data-icon="inline-start" />
                  <span className="truncate">{headerCta.label}</span>
                </Link>
              </Button>
              <div className="hidden max-w-32 truncate rounded-full bg-white/72 px-4 py-2 text-sm text-ink-soft sm:block">
        ...
        <main
          className={isConversationRoute
            ? 'mx-auto flex w-full min-w-0 max-w-[1440px] flex-1 overflow-hidden px-0 pt-20'
            : isProjectDashboardRoute
            ? 'mx-auto flex w-full min-w-0 max-w-[1440px] flex-1 overflow-hidden px-0'
            : 'mx-auto flex w-full min-w-0 max-w-[1440px] flex-1 overflow-y-auto overflow-x-hidden px-4 py-4 sm:px-6 lg:px-10 lg:py-6'}
        >
          <Outlet />
        </main>
      </div>
