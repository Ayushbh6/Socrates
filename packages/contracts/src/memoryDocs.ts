...
export const memoryDocRequiredSections: Record<MemoryDocType, string[]> = {
  ...
  user_profile: ["profile_summary", "stable_preferences", "collaboration_style", "work_and_projects", "personal_interests", "boundaries_and_dislikes", "recent_context", "evidence_index"],
