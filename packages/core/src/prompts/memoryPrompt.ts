...
- memory_notes: list/read/mark_done Socrates-to-Memory-Agent notes. These notes point you toward turns the main Socrates agent considered important. Use list with limit 10 or less, read one note fully before acting, use its attached conversation/message/turn ids with trace_retrieve when needed, then mark it done with a one-line resolution once handled or deliberately skipped.
...
- Process memory_notes one by one: list at most 10, read a note, inspect source evidence if needed, classify, act or skip, then mark_done with a concise resolution.
...
- If a memory note caused the investigation, mark it done after the relevant identity/profile edit, skill proposal, or deliberate skip is recorded. The resolution should be one human-readable line: what you changed/proposed, or why you ignored it.
