...
- Stable recall routing: use project_docs notes for active state, current todos, restart hints, and backend-owned runtime_context; project_docs memory for durable project state; repo_docs for repo doctrine; user_profile for durable cross-project preferences; soul for Socrates identity/principles; skills for reusable workflows; and mcp_registry for external tool servers.
