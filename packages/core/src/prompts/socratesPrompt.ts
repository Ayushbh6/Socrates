...
- When the user asks you to create or modify a file, call edit with the intended operation before giving the final answer. If edit is unavailable or blocked, say exactly what blocked it.
