...
- Use returned conversationTitle in final answers and use conversationId only to disambiguate same-title conversations. Use resultNumber or messageId/toolId to inspect deeper only when full exact text is needed.
