...
export const projectDocsTool: SocratesTool<typeof projectDocsToolInputSchema._type, typeof projectDocsToolOutputSchema._type> = {
  name: "project_docs",
  description:
    'Read, search, or edit workspace-local project docs under .socrates. area="memory" targets MEMORY.md for durable project state; area="notes" targets PROJECT_NOTES.md for active working notes. Edit is constrained by editMode append or replace.',
