...
export const projectDocsTool: SocratesTool<typeof projectDocsToolInputSchema._type, typeof projectDocsToolOutputSchema._type> = {
  name: "project_docs",
  description:
    'Read, search, or edit workspace-local project docs under .socrates. Call this for durable workspace state, current handoff facts, project-specific preferences, or the full project notes behind the startup map. area="memory" targets MEMORY.md for durable project state; area="notes" targets PROJECT_NOTES.md for active working notes. Edit is constrained by editMode append or replace.',
